...
class AddressBook(UserList):
    ...
    def __str__(self):
        ...
        for account in self.data:
            ...
            if account['phones']:
                ...
                phone = ', '.join(str(x) for x in new_value)
            else:
                phone = ''
            result.append(
    ...
    def add(self, record):
        ...
        self.log.log(f"Contact {record.name} has been added.")

    def save(self, file_name):
        with open(file_name + '.bin', 'wb') as file:
            pickle.dump(self.data, file)
        self.log.log("Addressbook has been saved!")
    ...
    def load(self, file_name):
        ...
        if emptyness.st_size != 0:
            ...
            self.log.log("Addressbook has been loaded!")
        else:
            self.log.log('Adressbook has been created!')
        return self.data
    ...
    def search(self, pattern, category):
        ...
        for account in self.data:
            ...
            elif account[category_new] == pattern_new:
                result.append(account)
        if not result:
    ...
    def edit(self, contact_name, parameter, new_value):
        ...
        try:
            ...
            self.log.log(f"Contact {contact_name} has been edited!")
            return True
        return False
    ...
    def remove(self, pattern):
        ...
        for account in self.data:
            if account['name'] == pattern:
                ...
                self.log.log(f"Contact {account['name']} has been removed!")
                flag = True
